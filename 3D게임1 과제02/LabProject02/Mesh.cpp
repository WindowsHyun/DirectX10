...
CBCubeMesh::CBCubeMesh( ID3D11Device *pd3dDevice, float fWidth, float fHeight, float fDepth, D3DXCOLOR d3dxColor ) : CMesh( pd3dDevice )
{
	...
	m_nIndices = 20;
	m_pnIndices = new UINT[m_nIndices];
	m_pnIndices[0] = 3; m_pnIndices[1] = 2; m_pnIndices[2] = 1; m_pnIndices[3] = 0;

	m_pnIndices[4] = 4; m_pnIndices[5] = 5; m_pnIndices[6] = 1; m_pnIndices[7] = 0;

	m_pnIndices[8] = 4; m_pnIndices[9] = 7; m_pnIndices[10] = 3; m_pnIndices[11] = 0;

	m_pnIndices[12] = 3; m_pnIndices[13] = 2; m_pnIndices[14] = 6; m_pnIndices[15] = 7;

	m_pnIndices[16] = 6; m_pnIndices[17] = 5; m_pnIndices[18] = 1; m_pnIndices[19] = 2;
